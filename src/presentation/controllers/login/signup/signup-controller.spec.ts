...
import { AccountModel, AddAccount, AddAccountModel, Validation, Authetication, AuthenticationModel } from './signup-controller-protocols'
...
interface SutType {
  ...
  authenticationStub: Authetication
